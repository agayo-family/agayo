...
## Последняя миграция лояльности
После 008 выполнить в Neon файл `db/009_flexible_loyalty.sql`. Это последняя структурная миграция перед подключением production-сервисов.
